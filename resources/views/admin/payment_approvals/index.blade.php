        ...
        <ul class="nav nav-tabs mb-4" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="pending-tab" data-bs-toggle="tab" href="#pending" role="tab">
                    ...
                    <span class="badge bg-warning ms-2">{{ $pendingPigSales->total() ?? 0 }}</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <div class="tab-pane fade show active" id="pending" role="tabpanel">
                <div class="table-responsive">
                    <table class="table table-primary mb-0">
                        ...
                        <tbody>
                            {{-- ✅ Display PigSale Pending Approvals Only --}}
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal"
                                            data-bs-target="#approvePigSaleModal{{ $pigSale->id }}">
                                            <i class="bi bi-check"></i> อนุมัติ
                                        </button>
                                        <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                            data-bs-target="#rejectPigSaleModal{{ $pigSale->id }}">
                                            <i class="bi bi-x"></i> ปฏิเสธ
                                        </button>
                                    </td>
                                </tr>

                                {{-- Approve PigSale Modal --}}
