                    ...
                    <div class="card-body">
                        <form action="{{ route('store_house_record.upload') }}" method="post"
                            ...
                            <template id="feedRowTemplate">
                                <div class="feed-row  card shadow-lg border-0 rounded-3 mb-3 p3" data-template
                                    style="display:none">
                                    ...
                                    <div class="card-body cardTemplateRow">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="feed[0][date]"
                                                    class="form-control date-input" placeholder="ว/ด/ป ชม.นาที"
                                                    required>
                                            </div>
                                            <div class="col-md-4">
                                                <select name="feed[0][item_type]" class="form-select item-type-select"
                                                    required>
                                            ...
                                            <div class="col-md-4">
                                                <select name="feed[0][item_code]" class="form-select item-code-select"
                                                    required>
                                                ...
                                                <input type="hidden" name="feed[0][item_name]"
                                            ...
                                            <div class="col-md-3">
                                                <input type="number" name="feed[0][price_per_unit]"
                                                    class="form-control" placeholder="ราคาต่อชิ้น">
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <input type="number" name="feed[0][transport_cost]"
                                                    class="form-control" placeholder="ค่าขนส่ง">
                                            </div>
                            ...
                            <template id="medicineRowTemplate">
                                <div class="medicine-row card shadow-lg border-0 rounded-3 mb-3 p3" data-template
                                    style="display:none">
                                    <input type="hidden" name="medicine[0][farm_id]" class="farm-id"
                                        value="">
                                    <input type="hidden" name="medicine[0][batch_id]" class="batch-id"
                                        value="">
                                    ...
                                    <div class="card-body cardTemplateRow">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-4">
                                                <select name="medicine[0][item_type]"
                                                    class="form-select item-type-select" required>
                                                    <option value="">-- เลือกประเภท --</option>
                                                    <option value="medicine">ค่ายา/วัคซีน</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                <select name="medicine[0][item_code]"
                                                    class="form-select item-code-select" required>
                                            ...
                                            <div class="col-md-4">
                                                <input type="number" name="medicine[0][price_per_unit]"
                                                    class="form-control" placeholder="ราคาต่อหน่วย">
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <!-- แถวล่าง: ใบเสร็จ + หมายเหตุ + ปุ่มลบ -->
                                            <div class="col-md-5">
                                                <input type="file" name="medicine[0][receipt_file]"
                                                    class="form-control">
                                            </div>
                                            <div class="col-md-6">
                            ...
                            <template id="monthlyRowTemplate">
                                <div class="monthly-row card shadow-lg border-0 rounded-3 mb-3 p3" data-template
                                    ...
                                    <input type="hidden" name="monthly[0][batch_id]" class="batch-id"
                                        value="">
                                    ...
                                    <div class="card-body cardTemplateRow">
                                        <div class="row g-3">
                                            ...
                                            <!-- แถวล่าง: ใบเสร็จ + หมายเหตุ + ปุ่มลบ -->
                                            <div class="col-md-5">
                                                <input type="file" name="monthly[0][receipt_file]"
                                                    class="form-control">
                                            </div>
                                            <div class="col-md-6">
