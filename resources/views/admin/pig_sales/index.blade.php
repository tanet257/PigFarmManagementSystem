                                ...
                                <div class="col-md-6">
                                    ...
                                    <table class="table table-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <strong
                                                    class="text-primary">{{ number_format($sell->price_per_pig ?? 0, 2) }}
                                                    บาท</strong>
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="batch_id" id="batch_select_create" class="form-select"
                                                required>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">ประเภทการขาย <span
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label">ราคาต่อ kg <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table class="table table-sm mb-0">
                                                ...
                                                <tr class="table-success">
                                                    ...
                                                    <td class="text-end fs-5 fw-bold"><span
                                                            id="summary_net_total">0.00</span>
                                                        บาท</td>
                                                </tr>
                                            </table>
                                        </div>
                                    ...
                                    @if ($latestPrice)
                                        ...
                                        <input type="hidden" name="cpf_reference_date"
                                            value="{{ $latestPrice['date'] }}">
                                    @endif
                                </div>
                            </div>
